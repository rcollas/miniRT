...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   color_create_bonus.c                               :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: efrancon <efrancon@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/03/24 18:34:50 by efrancon          #+#    #+#             */
/*   Updated: 2022/03/24 18:34:51 by efrancon         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	draw_pixel(
	t_image *image, unsigned long color, t_thread *thread)
{
	char	*dest;
	int		y;
	int		x;
